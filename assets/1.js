$(document).ready(function() {
    ...
    function sendConatcts() {
        ...
        document.getElementById('form-result').innerHTML = '<img src="https://ci.jumia.is/cms/1_JG/predict-and-win/icon-done-v1.gif" alt=""/><br/><div class="-costumer-request"><h1 >تم تاكيد طلبك بنجاح</h1><br/><a href="./index.html" style="color:white;">شكرا لك لزيارت موقعنا</a></div>';
